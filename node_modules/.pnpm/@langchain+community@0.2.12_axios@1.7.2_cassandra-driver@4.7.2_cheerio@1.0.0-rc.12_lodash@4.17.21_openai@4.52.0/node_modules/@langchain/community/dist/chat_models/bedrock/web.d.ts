...
export declare class BedrockChat extends BaseChatModel implements BaseBedrockInput {
    ...
    _generateNonStreaming(messages: BaseMessage[], options: Partial<BaseChatModelParams>, _runManager?: CallbackManagerForLLMRun): Promise<ChatResult>;
    ...
    _combineLLMOutput(): {};
    bindTools(tools: (StructuredToolInterface | Record<string, unknown>)[], _kwargs?: Partial<BaseChatModelCallOptions>): Runnable<BaseLanguageModelInput, BaseMessageChunk, BaseChatModelCallOptions>;
}
/**
