...
exports.ZepCloudMemory = exports.condenseZepMemoryIntoHumanMessage = void 0;
...
class ZepCloudMemory extends chat_memory_js_1.BaseChatMemory {
    ...
    async loadMemoryVariables(values) {
        ...
        if (this.returnMessages) {
            return {
                [this.memoryKey]: [(0, exports.condenseZepMemoryIntoHumanMessage)(memory)],
            };
        }
        return {
            [this.memoryKey]: (0, exports.condenseZepMemoryIntoHumanMessage)(memory).content,
        };
    }
    /**
